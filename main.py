...
def checkTeamStatus():
    ...
    if selectedTeam == 'Team A':
        ...
        if registered and medicalCert:
            resultDiv.innerHTML = 'you are in red bulldogs, you are now fully able 2 participate! ( ´ ꒳ ` ) ♡'
        elif registered:
        ...
        if registered and medicalCert:
            ...
            resultDiv.innerHTML = 'you are in blue bears, you are registered but you dont have a medical certificate (￣ ￣|||)'
        elif medicalCert:
        ...
        if registered and medicalCert:
            ...
            resultDiv.innerHTML = 'you are in green hornets, but you are not registered...`(°ー°〃)'
        else:
            resultDiv.innerHTML = 'you are not able to participate!(＃`Д´)'
        ...
        resultDiv.innerHTML = 'select a team plz'
